...
router.post('/', async(req, res) => {
    ...
    const Entity15 = axios.get(`${tenant}/data/SRF_HSEApprovalLineEntity?$format=application/json;odata.metadata=none&cross-company=true`, { headers: {'Authorization': "Bearer " + token}});
